...
export class UsuariosSistemaController {
  constructor(private readonly svc: UsuariosSistemaService) {}
  ...
  async crear(@Req() req: any, @Body() dto: CreateUsuarioSistemaDto) {
  ...
  @Put(':id')
  async actualizar(@Req() req: any, @Param('id') id: string, @Body() dto: UpdateUsuarioSistemaDto) {
