...
exports.CategoriasProductoController = void 0;
...
const categoria_producto_dto_1 = require("../dto/categoria-producto.dto");
const response_messages_1 = require("../../../common/constants/response-messages");
let CategoriasProductoController = class CategoriasProductoController {
    constructor(svc) {
        this.svc = svc;
    }
    async listar(req, q) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], CategoriasProductoController.prototype, "obtener", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, categoria_producto_dto_1.CreateCategoriaProductoDto]),
    __metadata("design:returntype", Promise)
], CategoriasProductoController.prototype, "crear", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, categoria_producto_dto_1.UpdateCategoriaProductoDto]),
    __metadata("design:returntype", Promise)
], CategoriasProductoController.prototype, "actualizar", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], CategoriasProductoController.prototype, "eliminar", null);
CategoriasProductoController = __decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('ADMIN_CLIENTE', 'SUPER_ADMIN'),
    (0, common_1.Controller)('categorias-producto'),
    __metadata("design:paramtypes", [categorias_producto_service_1.CategoriasProductoService])
], CategoriasProductoController);
exports.CategoriasProductoController = CategoriasProductoController;
//# sourceMappingURL=categorias-producto.controller.js.map