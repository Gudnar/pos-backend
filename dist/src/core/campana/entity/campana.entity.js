...
let Campana = class Campana extends auditoria_entity_1.AuditoriaEntity {
    constructor(data) {
        super(data);
        if (data)
...
__decorate([
    ...
    __metadata("design:type", String)
], Campana.prototype, "clienteId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'nombre', length: 200 }),
    __metadata("design:type", String)
], Campana.prototype, "nombre", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'canal', length: 50 }),
    __metadata("design:type", String)
], Campana.prototype, "canal", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'origen', length: 500, nullable: true }),
    __metadata("design:type", String)
], Campana.prototype, "origen", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], Campana.prototype, "agenteId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'activa', type: 'boolean', default: true }),
    __metadata("design:type", Boolean)
], Campana.prototype, "activa", void 0);
Campana = __decorate([
    (0, typeorm_1.Entity)({ name: 'campana', schema: process.env.DB_SCHEMA || 'public' }),
