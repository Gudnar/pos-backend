...
const especialista_service_1 = require("../service/especialista.service");
const especialista_dto_1 = require("../dto/especialista.dto");
const response_messages_1 = require("../../../common/constants/response-messages");
let EspecialistaController = class EspecialistaController {
    constructor(svc) {
        this.svc = svc;
    }
    async listar(req, especialidad) {
        const datos = await this.svc.listar(req.user.clienteId, especialidad);
        return { finalizado: true, mensaje: 'OK', datos };
    }
    async obtener(req, id) {
        const datos = await this.svc.obtener(id, req.user.clienteId);
        return { finalizado: true, mensaje: 'OK', datos };
    }
    async crear(req, dto) {
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('especialidad')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], EspecialistaController.prototype, "listar", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], EspecialistaController.prototype, "obtener", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, especialista_dto_1.CreateEspecialistaDto]),
    __metadata("design:returntype", Promise)
], EspecialistaController.prototype, "crear", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, especialista_dto_1.UpdateEspecialistaDto]),
    __metadata("design:returntype", Promise)
], EspecialistaController.prototype, "actualizar", null);
__decorate([
