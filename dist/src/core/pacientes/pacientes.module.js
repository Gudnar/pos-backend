...
const pacientes_controller_1 = require("./controller/pacientes.controller");
let PacientesModule = class PacientesModule {
};
PacientesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([paciente_entity_1.Paciente, consulta_entity_1.Consulta, cita_entity_1.Cita])],
